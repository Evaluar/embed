import { sendGaIdMessage, setupGoogleAnalyticsInstance } from './setup-google-analytics-instance'
...
describe('setup-google-analytics-instance', () => {
  ...
  describe('#setupGoogleAnalyticsInstance', () => {
    it('calls GA object correctly', () => {
      ...
      jest.runAllTimers()
      setupGoogleAnalyticsInstance(iframe, 'embed-id')
